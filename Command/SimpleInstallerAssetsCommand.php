...
/**
 * Simple installer assets command
 *
 * @author  Simon CARRE <simon.carre@clickandmortar.fr>
 * @package ZV\Bundle\CatalogBundle\Command
 */
class SimpleInstallerAssetsCommand extends Command
{
    protected static $defaultName = 'candm:installer:assets';
